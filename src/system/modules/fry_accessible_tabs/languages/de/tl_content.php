...
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_tabhead'][1]                   	= 'Dieses Element wird in die Navigation Transformierd.';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_position'][0]                  	= 'Positionierung der Navigation';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_position'][1]                  	= 'Definiert wo die Navigation eingefügt wird.';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_syncheights'][0]               	= 'Höhe anpassen';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_syncheights'][1]               	= 'Passt höhe der einzelnen Inhaltselementen dem grössten an.';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_save_state'][0]                	= 'Zustand sichern';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_save_state'][1]                	= 'Das aktive Tab wird in ein Cookie geschrieben (nur jQuery).';
...
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_pagination'][1]                	= 'Aktiviert die Vor- und Zurückschaltflächen (nur jQuery).';
...
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_fx'][0]                        	= 'Übergangsefekt';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_fx'][1]                        	= 'Definiert den Animationstyp beim wechsel zwischen den Tabs (nur jQuery).';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_fxspeed'][0]                   	= 'Übergangsefekt Dauer';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_fxspeed'][1]                   	= 'Die Dauer des Übergangefektes - mögliche werte [normal|fast|slow] oder millisekunden (nur jQuery).';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_wrapper_class'][0]             	= 'Klasse: umschlagendes DIV';
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_wrapper_class'][1]             	= 'Klassenname des, um den ursprünglichen Inhalt, umschlagenden DIV\'s.';
...
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_tabhead_class'][1]             	= 'Diese Klasse wird den zuvor definierten Heading Tags angefügt.';
...
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_responsive_toggler_class'][1]    = 'Diese Klasse wird dem UL Element zugewiesen wenn das Menu offen ist.';
...
$GLOBALS['TL_LANG']['tl_content']['accessible_tabs_clearfix_class'][1]            	= 'Diese Klasse ermöglicht eine eigene Clearfix-Klasse zu verwenden.';
