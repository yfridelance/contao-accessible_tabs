...
class AccessibleTabsDS 
{
    ...
    public function getJsTemplate($use_jquery = true)
    {
        ...
        $GLOBALS['TL_JAVASCRIPT'][] = '/system/modules/accessible_tabs/assets/scripts/' . $jsLib . '.tabs.js';
        if($this->enableSyncHeight)
        {
            $GLOBALS['TL_JAVASCRIPT'][] = '/system/modules/accessible_tabs/assets/scripts/' . $jsLib . '.syncheight.js';
        }
        if($this->enableCookiePlugin && $jsLib == 'jquery')
        {
            $GLOBALS['TL_JAVASCRIPT'][] = 'system/modules/accessible_tabs/assets/scripts/' . $jsLib . '.cookie.js';
        }
